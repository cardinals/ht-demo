 ...
 * @return {Number} 宽度值
 */
ht.ui.TabLayout.prototype.getTabWidth = function() {};
 ...
 * @param {Number} width 宽度值
 */
ht.ui.TabLayout.prototype.setTabWidth = function(width) {};
...
/**
 * 网格布局将布局空间划分为单元格矩阵(横向固定单元格数量，每个单元格宽度自适应；纵向固定每个单元格的高度，单元格数量自适应)，子组件可以指定起始单元格以及横向和纵向的跨度<br>
 * 子组件可用的布局参数(layoutParams)：
 * <ul>
 * <li> gridX 横向起点单元格下标 </li>
 * <li> gridY 纵向起点单元格下标 </li>
 * <li> colspan 横向跨单元格的数量 </li>
 * <li> rowspan 纵向跨单元格的数量 </li>
 * </ul>
 * 样式属性(不含从父类继承)：columnCount, gridHeight, gridGap, autoFlow
 * @param {Object} [properties] 属性配置对象
 * @constructor
 * @extends {ht.ui.ViewGroup}
 * @example
 * var btn = new ht.ui.Button({ text: 'Button' });
 * var gridLayout = new ht.ui.GridLayout();
 ...
 * gridLayout.addToDOM();
 */
ht.ui.GridLayout = function(properties) {};

/**
 * 是否启用了自动流动布局
 * @return {Boolean} 
 */
ht.ui.GridLayout.prototype.isAutoFlow = function() {};

/**
 * 设置是否启用自动流动布局
 * @param {Boolean} autoFlow 如果为 true 则 gridY 无法手动指定，而是在和其他子组件无重叠的情况下自动上移寻找合适的位置
 */
ht.ui.GridLayout.prototype.setAutoFlow = function(autoFlow) {};
 ...
 * @param {Number} count
 */
ht.ui.GridLayout.prototype.setColumnCount = function(count) {};
 ...
 * @return {Number}
 */
ht.ui.GridLayout.prototype.getColumnCount = function() {};

/**
 * 设置单元格的纵向高度
 * @param {Number} height
 */
ht.ui.GridLayout.prototype.setGridHeight = function(height) {};

/**
 * 获取单元格的纵向高度
 * @return {Number}
 */
ht.ui.GridLayout.prototype.getGridHeight = function() {};

/**
 * 设置单元格之间的空白距离
 * @param {Number} gap
 */
ht.ui.GridLayout.prototype.setGridGap = function(gap) {};

/**
 * 获取单元格之间的空白距离
 * @return {Number}
 */
ht.ui.GridLayout.prototype.getGridGap = function() {};
/**
 ...
 * @return {Boolean}             事件是否派发成功
 */
ht.ui.DockManager.prototype.firePropertyChange = function(property, oldValue, newValue, compareFunc) {}

/**
 * 派发属性变化事件，{@link ht.ui.DockManager#firePropertyChange firePropertyChange} 的缩写
 * @param  {String} property    属性名
 * @param  {Object} oldValue    属性变化之前的值
 * @param  {Object} newValue    属性变化之后的值
 * @param  {function} [compareFunc] 比较函数，用于比较新值和旧值是否一致，如果一致则不会派发事件
 * @return {Boolean}             事件是否派发成功
 */
ht.ui.DockManager.prototype.fp = function(property, oldValue, newValue, compareFunc) {}
 ...
 * @param {Boolean} [ahead] 是否将当前监听器插入到监听器列表开头
 */
ht.ui.DockManager.prototype.addPropertyChangeListener = function(listener, scope, ahead) {}

/**
 * 增加属性事件变化监听函数，{@link ht.ui.DockManager#addPropertyChangeListener addPropertyChangeListener} 的缩写
 * @param {function} listener 监听器函数
 * @param {Object} [scope]    函数域
 * @param {Boolean} [ahead] 是否将当前监听器插入到监听器列表开头
 */
ht.ui.DockManager.prototype.mp = function(listener, scope, ahead) {}
 ...
 * @param {Object} [scope]    函数域
 */
ht.ui.DockManager.prototype.removePropertyChangeListener = function(listener, scope) {}

/**
 * 删除属性事件变化监听器，{@link ht.ui.DockManager#removePropertyChangeListener removePropertyChangeListener} 的缩写
 * @param {function} listener 监听器函数
 * @param {Object} [scope]    函数域
 */
ht.ui.DockManager.prototype.ump = function(listener, scope) {}


/**
 * 绑定 SplitLayout 布局器并在此布局器上启用 dock 功能
 * @param {ht.ui.SplitLayout} splitLayout
 */
ht.ui.DockManager.prototype.setViewGroup = function(splitLayout) {}


/**
 * 获取绑定的 SplitLayout 布局器对象
 * @return {ht.ui.SplitLayout}
 */
ht.ui.DockManager.prototype.getViewGroup = function() {}


/**
 * 设置拖拽提示遮罩的背景颜色
 * @param {color} color 背景颜色，如 '#ff0000'
 */
ht.ui.DockManager.prototype.setMaskBackground = function(color) {}
 ...
 * @return {color}
 */
ht.ui.DockManager.prototype.getMaskBackground = function() {}
 ...
 * @param {color} color 背景颜色，如 '#ff0000'
 */
ht.ui.DockManager.prototype.setRootMaskBackground = function(color) {}
 ...
 * @return {color}
 */
ht.ui.DockManager.prototype.getRootMaskBackground = function() {}

/**
 * 设置拖拽插入线的颜色
 * @param {color} color 颜色，如 '#ff0000'
 */
ht.ui.DockManager.prototype.setInsertLineColor = function(color) {}
 ...
 * @return {color}
 */
ht.ui.DockManager.prototype.getInsertLineColor = function() {}

/**
 * 设置拖拽到根容器时的点击范围
 * @param {int} size
 */
ht.ui.DockManager.prototype.setRootHitSize = function(size) {}
 ...
 * @return {int}
 */
ht.ui.DockManager.prototype.getRootHitSize = function() {}
...
/**
 * 设置输入组件
 * @param {ht.ui.View} input 输入组件
 */
ht.ui.InputGroup.prototype.setInput = function (input){};
 ...
 * @return {String} 工具提示文本内容
 */
ht.ui.Slider.prototype.getToolTip = function (e) {};
 ...
 * </tr>
 * <tr>
 * <td class="name"><code>checkData</code></td>
 * <td> { kind: 'checkData', data: data } </td>
 * <td>check 模式下，鼠标点击节点复选框选中时派发的事件 </td>
 * </tr>
 * <tr>
 * <td class="name"><code>uncheckData</code></td>
 * <td> { kind: 'checkData', data: data } </td>
 * <td>check 模式下，鼠标点击节点复选框取消选中时派发的事件 </td>
 * </tr>
 * </tbody>
 * </table>
...
/**
 * 模拟鼠标点击勾选一个节点
 * @param {ht.Data} data 节点
 */
ht.ui.TreeView.prototype.checkData = function (data){};

/**
 * 模拟鼠标点击勾选一批节点
 * @param {Array} datas 节点数组
 */
ht.ui.TreeView.prototype.checkDatas = function (datas){};
/**
 ...
 * @param {ht.Data} data 节点
 */
ht.ui.TreeTableView.prototype.checkData = function (data){};

/**
 * 模拟鼠标点击勾选一批节点
 * @param {Array} datas 节点数组
 */
ht.ui.TreeTableView.prototype.checkDatas = function (datas){};
/**
